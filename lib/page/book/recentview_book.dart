...
class _RecentViewBookState extends State<RecentViewBook> {
  ...
  late Future<List<RecentlyView>> futureRecentView;

  @override
  void initState() {
    super.initState();
    futureRecentView = fetchRecentView();
  }
        ...
        child: Column(
          ...
          children: [
            ...
            SingleChildScrollView(
              child: FutureBuilder<List<RecentlyView>>(
                future: futureRecentView,
                                  ...
                                  Navigator.pushReplacement(
                                    ...
                                    MaterialPageRoute(
                                      builder: (context) => RecentlyViewDetails(
                                        recentViewModel: snapshot.data![index],
                                      ),
                                    ),
                                  );
                                },
